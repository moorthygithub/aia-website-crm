...
const SignUPList = () => {
  const {
    ...
    queryFn: async () => {
      ...
      const response = await apiClient.get(`/api/fetch-signupuser-list`);
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <SignUpEdit signUpData={row.original} />
                </TooltipTrigger>
                <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    userToDelete?.id === row.original.id ? (
