...
const sliderImages = [
  {
    ...
    description:
      "Become part of a movement empowering tribal communities through education and development",
    image:
  ...
  },
  {
    ...
    description:
      "Together we can create lasting change and build better futures",
    image:
...
export default function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const res = await apiClient.post(`/api/panel-signup`, signupData);

      if (res.data.code === 201) {
        toast.success(
          "Account created successfully! An admin will contact you with login credentials."
        );
                      ...
                      <div className="space-y-1">
                        ...
                        >
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("user_chapter", e.target.value)
                            }
                            required
                            className={`h-10 border-gray-300 focus:border-[var(--color-border)] focus:ring-[var(--color-border)] transition-colors ${
