...
const DonorDownload = () => {
  ...
  const downloadMutation = useMutation({
    mutationFn: async (downloadData) => {
      const response = await apiClient.post(DOWNLOAD_DONOR, downloadData, {
        responseType: "blob",
      });
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Title",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Title")}</div>
      ),
    },
    {
      accessorKey: "Name",
    ...
    },
    {
      ...
      header: "Type",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Type")}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      header: "Father Name",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Father Name")}</div>
      ),
    },
    {
      ...
      header: "Mother Name",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Mother Name")}</div>
      ),
    },
    {
      accessorKey: "Gender",
      ...
      header: "Gender",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Gender")}</div>
      ),
    },
    {
      accessorKey: "Spouse",
      ...
      header: "Spouse",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Spouse")}</div>
      ),
    },
    {
      accessorKey: "PAN No",
      ...
      header: "PAN No",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("PAN No")}</div>
      ),
    },
    {
      accessorKey: "Mobile",
    ...
    },
    {
      ...
      header: "Whatsapp",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Whatsapp")}</div>
      ),
    },
...

    {
      ...
      header: "City",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("City")}</div>
      ),
    },

    {
      ...
      header: "CSR",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("CSR")}</div>
      ),
    },
    {
      ...
      header: "Belongs To",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Belongs To")}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      header: "Source",
      cell: ({ row }) => (
        <div className="text-xs font-medium">{row.getValue("Source")}</div>
      ),
    },
  ];
      ...
      <div className="p-4">
        <form className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="indicomp_type" className="text-sm">
                Source
              </Label>
              <Select
                value={formData.indicomp_type}
                onValueChange={(value) =>
                  handleSelectChange("indicomp_type", value)
                }
              >
                <SelectTrigger className="h-9">
