...
/*--------------------------Master-start----------------------------------- */
// CHAPTER
export const CHAPTER_LIST = `/api/fetch-chapters`;
export const ADD_CHAPTER_SUMBIT = `/api/chapter`;
// (view)-- add school pending
export const CHAPTER_VIEW_BY_ID = `/api/fetch-chapter-by-id`;
export const CHAPTER_VIEW_CREATE_USER = `/api/create-user`;
export const CHAPTER_VIEW_UPDATE_USER = `/api/update-user`;
//(edit)
export const CHAPTER_EDIT_BY_ID = `/api/chapter`;
export const CHAPTER_EDIT_BY_ID_UPDATE = `/api/chapter`;
export const CHAPTER_EDIT_STATES_DROPDOWN = `/api/panel-fetch-state`;
// (datasource)
export const CHAPTER_DATASOURCE_BY_ID_LIST = `/api/fetch-data-sources-by-id`;
export const CHAPTER_DATASOURCE_CREATE = `/api/data-source`;
export const CHAPTER_DATASOURCE_UPDATE_BY_ID = `/api/data-source`;

//STATES
export const STATES_LIST = `/api/fetch-states`;
export const CREATE_STATES = `/api/create-states`;
export const UPDATES_STATES = `/api/update-states`;

//DESIGNATION
export const DESIGNATION_LIST = `/api/fetch-designation`;
export const CREATE_DESIGNATION = `/api/create-designation`;
export const UPDATES_DESIGNATION = `/api/update-designation`;

//EXPENSIVE_TYPE

export const EXPENSIVE_TYPE_LIST = `/api/fetch-ots-exptypes`;
export const CREATE_EXPENSIVE_TYPE = `/api/create-ots-exptypes`;
export const UPDATES_EXPENSIVE_TYPE = `/api/update-ots-exptypes`;

//FAQ

export const FAQ_LIST = `/api/fetch-faqs`;
export const CREATE_FAQ = `/api/create-faqs`;
export const UPDATES_FAQ = `/api/update-faqs`;

/*--------------------------Master-end----------------------------------- */

//CREATE FOLLOWUP
export const CREATE_FOLLOWUP_API_URL = `/api/followup`;
export const FOLLOWUP_GET_DATA = `/api/followup`;

/*--------------------------Donor-start----------------------------------- */
//FULL LIST
export const DONOR_LIST = `/api/fetch-donors`;
export const DONOR_LIST_CREATE_RECEIPT = `/api/receipt`;
export const DONOR_LIST_CREATE_RECEIPT_FETCH = `/api/donor`;
export const DONOR_VIEW_DATA = `/api/fetch-donor-by-id`;
export const DONOR_VIEW_OLD_RECEIPT_LIST = `/api/fetch-receipts-by-old-id`;
export const DONATION_DETAILS_LIST = `/api/fetch-donor-receipt-by-id`;
export const MEMBERSHIP_DETAILS_LIST = `/api/fetch-donor-receipt-by-id`;
export const FAMILY_DETAILS_LIST = `/api/fetch-donor-by-id`;
export const COMPANY_DETAILS_LIST = `/api/fetch-donor-by-id`;
export const DONOR_INDIVISUAL_CREATE_SUMBIT = `/api/donor`;

export const DONOR_CHANGE_PROMOTER_UPDATE_SUMBIT = `/api/update-promoter`;

export const DONOR_COMPANY_CREATE_SUMBIT = `/api/donor`;
export const DONOR_COMPANY_UPDATE_SUMBIT = `/api/donor/`;
export const DONOR_INDIVISUAL_UPDATE_SUMBIT = `/api/donor/`;
export const DONOR_INDIVISUAL_FAMILY_GROUP_UPDATE = `/api/update-donor-leavegroup/`;
export const DONOR_COMPANY_FAMILY_GROUP_UPDATE = `/api/update-donor-leavegroup/`;
export const DONOR_COMPANY_EDIT_FETCH = `/api/donor`;
export const DONOR_INDIVISUAL_EDIT_FETCH = `/api/donor`;
// pending

//MEMBERS
export const MEMBERS_LIST = `/api/fetch-members`;
export const SEND_EMAIL = `/api/send-membership-renew?id=`;

export const MEMBER_DASHBOARD = `/api/member`;
export const MEMBER_ACTIVE_DATA = `/api/member-data?type=1`;
export const MEMBER_INACTIVE_DATA = `/api/member-data?type=2`;

export const SEND_BULK_EMAIL = `/api/member`;

//VIEWVER
export const VIEWVER_LIST = `/api/superadmin-get-all-viewers`;

//changed
export const VIEWVER_CREATE = `/api/create-user`;

export const VIEWVER_EDIT_BY_ID = `/api/fetch-user-by-id`;
export const VIEWVER_EDIT_UPDATE = `/api/update-viewer`;

//DUPLICATE
export const DUPLICATE_LIST = `/api/donor-duplicate`;
export const DUPLICATE_DELETE = `/api/delete-donor-duplicate/`;
export const DUPLICATE_EDIT_BY_ID = `/api/donor`;
export const DUPLICATE_EDIT_BY_ID_UPDATE = `/api/update-donor-duplicate`;

/*--------------------------Donor-end----------------------------------- */

/*--------------------------Reciept-start----------------------------------- */
export const RECEIPT_LIST = `/api/fetch-receipts`;
export const RECEIPT_OLD_LIST = `/api/fetch-receipts-old`;
export const RECEIPT_SUSPENSE_LIST = `/api/fetch-suspense-list`;

export const RECEIPT_SUSPENSE_UPDATE = `/api/update-suspense-receipt`;
// (edit)
export const RECEIPT_EDIT_BY_ID_DONOR_DATA = `/api/fetch-donor-by-id`;

export const RECEIPT_EDIT_BY_ID = `/api/fetch-receipt-by-id`;
export const RECEIPT_EDIT_OLD_BY_ID = `/api/fetch-receipt-by-old-id`;

export const RECEIPT_EDIT_BY_ID_UPDATE = `/api/update-receipt`;
export const RECEIPT_EDIT_BY_ID_OLD_UPDATE = `/api/update-receipt-old`;
// (view)
export const RECEIPT_VIEW_BY_ID = `/api/fetch-receipt-by-id`;

export const RECEIPT_OLD_VIEW_BY_ID = `/api/fetch-receipt-by-old-id`;
export const RECEIPT_OLD_20_TO_22_VIEW_BY_ID = `/api/fetch-receipt-2020to2022-by-old-id`;

export const RECEIPT_VIEW_THREE_BY_ID = `/api/fetch-receipt-by-id`;
export const RECEIPT_VIEW_SEND_EMAIL = `/api/send-receipt`;
export const RECEIPT_VIEW_SEND_EMAIL_OLD = `/api/send-receipt-old`;
export const RECEIPT_VIEW_SEND_EMAIL_OLD_20_TO_22 = `/api/send-receipt-2020to2022-old`;

// export const RECEIPT_VIEW_SEND_EMAIL = `/api/send-receipt?id=`;
export const RECEIPT_VIEW_SUMBIT = `/api/update-donor-email`;
...
export const DASHBOARD_YEAR = `/api/fetch-year`;
// export const DASHBOARD_SUPERADMIN_NOTICE = `/api/superadmin-fetch-notices`;
// export const DASHBOARD_USER_NOTICE = `/api/user-fetch-notices`;

export const DASHBOARD_NOTICE = `/api/notice`;
export const DASHBOARD_DATA = `/api/dashboard`;

export const DASHBOARD_MARK_NOTICE_AS_READ = `/api/notices`;
/*--------------------------Dashboard-end----------------------------------- */
...
//PAYMENT SUMMARY
export const PAYMENT_SUMMARY_VIEW = `/api/fetch-teacher-payment-summary-by-date`;
export const PAYMENT_SUMMARY_DOWNLOAD = `/api/download-teacher-payment-summary-by-date`;
...
/*--------------------------Download-start----------------------------------- */
//DONOR
export const DOWNLOAD_DONOR = `/api/download-donor`;
//DOWNLOAD ALL RECEIPT
export const DOWNLOAD_ALL_RECEIPT = `/api/download-receipt-all`;
export const DOWNLOAD_DROPDOWN_DATASOURCE = `/api/fetch-datasource`;
export const DOWNLOAD_DROPDOWN_CHAPTER = `/api/fetch-chapters`;
export const DOWNLOAD_DROPDOWN_PROMOTER = `/api/fetch-promoter`;

// DOWNLOAD PURCHASE(OTS)
export const DOWNLOAD_PURCHASE_OTS = `/api/download-ots`;
//DOWNLOAD RECEIPTS
export const DOWNLOAD_RECEIPT = `/api/download-receipt`;
export const DOWNLOAD_RECEIPT_DROPDOWN_DATASOURCE = `/api/data-source`;
//DOWNLOAD TEAM
export const DOWNLOAD_TEAM = `/api/download-team-summary`;
//SCHOOL
export const DOWNLOAD_SCHOOL_ALLOTED = `/api/download-school-alloted`;
export const DOWNLOAD_SCHOOL_UNALLOTED = `/api/download-school-unalloted`;

/*--------------------------Download-end----------------------------------- */

/*--------------------------Other-start----------------------------------- */
//FAQ
export const OTHER_FAQ = `/api/faq`;
export const OTHER_FAQ_DOWNLOAD = `/api/download-faq`;
...
//not used
export const OTHER_TEAM_COMMITTEE_DELETE = `/api/delete-commitee`;
...
//NOTIFICATION
export const OTHER_NOTIFICATION_SUPERADMIN = `/api/superadmin-fetch-notices`;
export const OTHER_NOTIFICATION = `/api/notice`;
export const OTHER_NOTIFICATION_MARK_AS_READ = `/api/notices`;
export const OTHER_NOTIFICATION_SUMBIT_NOTICE = `/api/notice`;
/*--------------------------Other-end----------------------------------- */
...
export const ADMIN_CHAPTER_DATA_CHAPTER_LIST = `/api/fetch-profile`;
export const ADMIN_CHAPTER_CREATE = `/api/create-user`;
export const ADMIN_CHAPTER_EDIT_UPDATE = `/api/update-user`;
export const ADMIN_CHAPTER_UPDATE = `/api/chapter/`;

export const ADMIN_CHAPTER_SCHOOL_VIEW_CHAPTER = `/api/fetch-chapters`;

export const ADMIN_CHAPTER_SCHOOL_VIEW_DATA = `/api/fetch-viewer-by-id`;
export const ADMIN_CHAPTER_SCHOOL_UPDATE = `/api/update-school`;

/*--------------------------Chapter-end(admin)----------------------------------- */

/*--------------------------Datasource-start(admin)----------------------------------- */
export const ADMIN_DATASOURCE_CREATE = `/api/data-source`;
export const ADMIN_DATASOURCE_LIST = `/api/fetch-datasource`;
export const ADMIN_DATASOURCE_UPDATE = `/api/data-source`;
